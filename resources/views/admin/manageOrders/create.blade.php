        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.manageOrder.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.manage-orders.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('bill_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bill_no" id="bill_no" value="{{ old('bill_no', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('customerid') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="customerid" id="customerid" value="{{ old('customerid', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('total_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_product') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_product" id="total_product" value="{{ old('total_product', '') }}" step="1" required>
